(function($) {
  ...
  drooids.__globals__ = {
    ...
    contactEmails: [
      ...
      {email: "sigrunerla94@gmail.com", name: "Sigrun"},
      {email: "sigrun@drooids.com", name: "Sigrun"},
    ],
  }
  ...
  drooids.onload(function(e) {
    ...
    var date = new Date();
    document.getElementById('id-copy-right').innerHTML =
    "Copyright © " + drooids.__globals__.brand + " " + date.getUTCFullYear();

  });

  window.drooids = drooids;
